  ...
  return (
    <div className="w-full">
      <div className="flex justify-center">
        <div className="flex flex-col items-center md:flex-row w-full bg-navy py-6 rounded-b-3xl">
      ...
      <select
        ...
        value={sortOrder}
        className="px-2 py-2 mt-4 mr-12 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-hover_button"
      >
